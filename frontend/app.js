...
function overview(){
 ...
 return heading('PROJECT DIRECTORY',project.name,project.description||'A clearer view of your project. From the overall plan to the smallest detail.',tag('◷  Tender drawing set'))+stats()+
